  ...
  <div class="home">
    <v-card>
      <v-card-text>
        ...
        <p>
          <b>ref:</b> computedNameLength: {{ person1.computedNameLength }}
        </p></v-card-text
      >
      <v-card-text>
        ...
        <p>
          <b>reactive:</b> computedNameLength: {{ person2.computedNameLength }}
        </p>
        <p>
          <b>computedAgePulusFive:</b> {{ computedAgePulusFive }}
        </p></v-card-text
      >
    </v-card>
