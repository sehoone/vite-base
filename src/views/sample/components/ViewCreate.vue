<template>
  <a-card hoverable style="width: 100%">
    ...
    >
      ...
      <a-form-item label="content" name="content" :rules="[{ required: true, message: 'Please input content' }]">
        <a-input v-model:value="formState.content" />
      </a-form-item>

      <a-form-item label="author" name="author" :rules="[{ required: true, message: 'Please input author' }]">
